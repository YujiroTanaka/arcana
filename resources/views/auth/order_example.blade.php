        ...
        <div class="col-12 mb-4">
          <div class="card">
            <div class="card-header bg-secondary">
              <h3 class="card-title pt-1">オーダー事例一覧</h3>
              <a class="ml-4" href="order-example/register">
                ...
                <tbody>
                  @foreach($examples as $example)
                    <tr>
                      ...
                      <td>
                        <a href="order-example/edit/{{ $example->id }}">
                          <span class="badge bg-secondary">編集</span>
                        </a>
                      </td>
                      <td>
                        <a href="order-example/delete/{{ $example->id }}" onclick="return confirm('削除しますか？')">
