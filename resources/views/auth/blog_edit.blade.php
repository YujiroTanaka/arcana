          ...
          <div class="card card-primary">
            <div class="card-header">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  <label>表示日時</label>
                  {{ Form::date('display_date', $blog->display_date, ['class' => 'form-control']) }}
                ...
                <div class="form-group">
                  ...
                  <div id="dropzone" class="dropzone-area">
                    ...
                    <div id="dropzone-placeholder" @if($blog->thumbnail_url) style="display:none;" @endif>
                      <i class="fas fa-cloud-upload-alt fa-3x text-muted"></i>
                      <p class="mt-2 mb-0 text-muted">ここに画像をドラッグ＆ドロップ</p>
                      <p class="text-muted"><small>またはクリックしてファイルを選択</small></p>
                    </div>
                    <div id="thumbnail-preview" @if(!$blog->thumbnail_url) style="display:none;" @endif>
                      <img id="preview-img" src="{{ $blog->thumbnail_url }}" alt="preview">
...
<script>
  ...
  detailInput.value = detail.querySelector('.ql-editor').innerHTML;
