        ...
        <div class="col-12 mb-4">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">リペア事例編集</h3>
            </div>
            <form action="/admin/repair-example/edit/{{ $example->id }}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="card-body">
                ...
                <div class="form-group">
                  <label>URL</label>
                  <input type="url" name="url" class="form-control" value="{{ $example->url }}" placeholder="https://...">
                </div>
                <div class="form-group">
                ...
                <a href="/admin/repair-example" class="btn btn-secondary ml-2">戻る</a>
              </div>
            </form>
          </div>
        </div>
